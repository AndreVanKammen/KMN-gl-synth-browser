...
const scopeShaderHeader = baseComponentShaderHeader + `
...
vec2 getSample(float lineX) {
  int currentBuffer = int(value.y) / bufferHeight;
...
const scopeShaderHeaderOutput = baseComponentShaderHeader + `
...
mat2x4 getEnergy() {
  vec4 raem = vec4(value.z,0.0,value.zz);
